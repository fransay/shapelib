...
func TestPoint3DSize(t *testing.T) {
	var point3DSizeObj = Point3D{X: 2, Y: 3}
...
func TestPoint3DTranslate3D(t *testing.T) {
	...
	var point3DTranslate3DObserved = point3DSizeObj.Translate3D(Point3D{X: 2, Y: 4, Z: 5})
	var point3DTranslated3DExpected = Point3D{X: 4, Y: 7, Z: 8}
