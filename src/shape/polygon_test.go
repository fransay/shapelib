...
func TestPolygonNumberOfNodes(t *testing.T) {
	var polygonOne = Polygon{geom.Point2D{X: 7, Y: 9}, geom.Point2D{X: 2, Y: 6}, geom.Point2D{X: 4, Y: 8}}
...
func TestPolygonLineSegment(t *testing.T) {
	...
	var polygonTwo = Polygon{geom.Point2D{X: 7, Y: 9}, geom.Point2D{X: 2, Y: 6}, geom.Point2D{X: 4, Y: 8}, geom.Point2D{X: 4, Y: 50}}
	...
	var polygonThree = Polygon{geom.Point2D{X: 7, Y: 9}, geom.Point2D{X: 2, Y: 6}, geom.Point2D{X: 4, Y: 8}, geom.Point2D{X: 12, Y: 43},
		geom.Point2D{X: 45, Y: 645}}
...
func TestPolygonCentroid(t *testing.T) {
	...
	var centroidExpected = geom.Point2D{X: 6.5, Y: 11.5}
	if centroidExpected != centroidResults {
		t.Errorf("Expected %f, Got %f", centroidExpected, centroidResults)
	}
	// polygon instance two
	var polygonTwo = Polygon{geom.Point2D{X: 1, Y: 5}, geom.Point2D{X: 6, Y: 9}, geom.Point2D{X: 5, Y: 10}}
	var centroidTwoResult = polygonTwo.Centroid()
	var centroidTwoExpected = geom.Point2D{X: 6, Y: 12}
	if centroidTwoExpected != centroidTwoResult {
		t.Errorf("Expected %f, Got %f", centroidTwoExpected, centroidTwoResult)
	}

	// polygon instance three
	var polygonThree = Polygon{geom.Point2D{X: 60, Y: 50}, geom.Point2D{X: 22, Y: 65}, geom.Point2D{X: 40, Y: 8}}
	var centroidThreeResults = polygonThree.Centroid()
	var centroidThreeExpected = geom.Point2D{X: 61.0, Y: 61.5}
...
func TestNumberOfLineSegments(t *testing.T) {
	var polygonOne = Polygon{geom.Point2D{X: 60, Y: 50}, geom.Point2D{X: 22, Y: 65}, geom.Point2D{X: 40, Y: 8}}
...
func TestRotate(t *testing.T) {
	var polygonOne = Polygon{geom.Point2D{X: 60, Y: 50}, geom.Point2D{X: 22, Y: 65}, geom.Point2D{X: 40, Y: 8}}
	var polygonTwo = Polygon{geom.Point2D{X: 130.71132228476674, Y: 110.83117391955632}, geom.Point2D{X: 25.446469962218117, Y: 31.677564464354067}, geom.Point2D{X: 446.7709136776561, Y: 302.49969654271126}}
...
func TestScale(t *testing.T) {
	...
	var scaledPolygonExpected = Polygon{geom.Point2D{X: 120, Y: 100}, geom.Point2D{X: 44, Y: 130}, geom.Point2D{X: 80, Y: 16}}
...
func TestIsEqual(t *testing.T) {
	var polygonOne = Polygon{geom.Point2D{X: 60, Y: 50}, geom.Point2D{X: 22, Y: 65}, geom.Point2D{X: 40, Y: 8}}
	var polygonTwo = Polygon{geom.Point2D{X: 10, Y: 20}, geom.Point2D{X: 5, Y: 15}, geom.Point2D{X: 30, Y: 15}}
...
func TestContains(t *testing.T) {
	var polygonOne = Polygon{geom.Point2D{X: 60, Y: 50}, geom.Point2D{X: 22, Y: 65}, geom.Point2D{X: 40, Y: 8}}
	var polygonTwo = Polygon{geom.Point2D{X: 10, Y: 20}, geom.Point2D{X: 5, Y: 15}, geom.Point2D{X: 30, Y: 15}}
	var ContainsPolygonObserved = polygonOne.Contains(polygonTwo, geom.Point2D{X: 10, Y: 20})
