...
// func (p *Point2D) Buffer(radius float64) *Circle {
// 	return &Circle{Radius: radius, Centroid: *p}
// }
// todo:  // implement a circle type in geom
...
func areaByCoordinates(cords ...Point2D) float64 {
	var forPass float64
...
func (p *Point2D) pointOnLine(segment LineSegment) (onLine bool) {
	var area = areaByCoordinates(*p, segment.PointA, segment.PointB)
