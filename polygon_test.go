...
func TestPolygonNumberOfNodes(t *testing.T) {
	var polygonOne = types.Polygon{point.Point2D{X: 7, Y: 9}, point.Point2D{X: 2, Y: 6}, point.Point2D{X: 4, Y: 8}}
...
func TestPolygonLineSegment(t *testing.T) {
	...
	var polygonTwo = types.Polygon{point.Point2D{X: 7, Y: 9}, point.Point2D{X: 2, Y: 6}, point.Point2D{X: 4, Y: 8}, point.Point2D{X: 4, Y: 50}}
	...
	var polygonThree = types.Polygon{point.Point2D{X: 7, Y: 9}, point.Point2D{X: 2, Y: 6}, point.Point2D{X: 4, Y: 8}, point.Point2D{X: 12, Y: 43},
...
func TestPolygonCentroid(t *testing.T) {
	...
	// polygon instance two
	var polygonTwo = types.Polygon{point.Point2D{X: 1, Y: 5}, point.Point2D{X: 6, Y: 9}, point.Point2D{X: 5, Y: 10}}
	...
	// polygon instance three
	var polygonThree = types.Polygon{point.Point2D{X: 60, Y: 50}, point.Point2D{X: 22, Y: 65}, point.Point2D{X: 40, Y: 8}}
